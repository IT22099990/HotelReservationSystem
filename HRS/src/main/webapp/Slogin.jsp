...
<body>
	...
	<h1>Staff Login</h1> 
        <form action="login" method="POST">
            ...
            <input type="text" class="tag4" placeholder="Enter Username" name="username" required><br>
            <label for="Password" class="tag">Password</label><br>
            <input type="text" class="tag4" placeholder="Enter Password" name="password" required><br><br>
            <button type="submit" value="Submit" class ="btn"><a>Login</a></button><br><br>
          </form>
	</div> 
