...
<html>
    <head>
        ...
        <script src="https://kit.fontawesome.com/home.js" crossorigin="anonymous"></script>
    ...
    <body>
 	...
 	<div class = "sidenav" id = "sidenav">
            ...
            <!--  <ul class = "navbar">
                ...
                <li><a href = "availabilityForm.jsp">Add Availability</a></li>
                <li><a href = "StaffAvailabilityAccess.jsp">Availability Access</a></li>
                <li><a href = "#">customer support form</a></li>
