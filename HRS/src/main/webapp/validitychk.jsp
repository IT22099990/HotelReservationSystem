...
<div class="chk">
	<h1>Customer Support</h1>
        <form action="care" method="POST">
            ...
            <input type="text" class="tag4" name="hotel" required><br><br>
            <label for="section" class="tag">Section</label><br>
            <input type="text" class="tag4" name="section"><br><br>
            
            <button type="submit" value="Check" class ="btn">Check</button><br><br>
          </form>
	</div> 
		<!-- footer -->
<footer class = "footer">
